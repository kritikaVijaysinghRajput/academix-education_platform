          ...
          <div className="bg-white rounded-2xl w-full h-full shadow p-4 relative border ">
            <div>
              ...
              <form className="flex-1 mt-10">
                ...
                <button className=" shadow-lg p-5 w-full flex border m-2 justify-center items-center gap-2 rounded-lg text-black">
                  <svg
...
export default CreateShareResources;
