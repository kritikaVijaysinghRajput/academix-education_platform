  ...
  return (
    <div>
      <div className="navbar p-3 flex justify-between items-center">
        <div className="logo">
          <p className="font-bold text-2xl text-primary">ACADEMIX</p>
        </div>
        <div className="middle flex items-center gap-4 justify-center">
          <div className="search w-96 flex border rounded-xl items-center p-2">
            <svg
          ...
          <Link
            to="/login"
            className=" flex ml-50 bg-primary text-white shadow-lg p-2  items-center  gap-2 rounded-lg"
          >
            SignIn
          </Link>
        </div>
